...
#include <arpa/inet.h>
#define UNIX_DOMAIN "/sys/testjwmvo.domain"
...
typedef struct {
	...
	uint32_t odo: 24,						//byte3 ~ 6: 0 ~ 23 总里程
		...
		lcdNightLight: 5;					//byte3 ~ 6: 27 ~ 31 LCD屏亮度(黑夜)
	...
	uint8_t okBtn: 1,						//byte12: 0 页面切换开关状态
		...
		lcdLight: 4;						//byte12: 4 ~ 7 LCD屏亮度(白天)
	...
	uint8_t wavCharge: 1,					//byte24: 0 开始充电语音报警标志
	...
	uint16_t pepsPowerStatus: 3,			//byte41 ~ 42: 0 ~ 2 PEPS电源状态
		seltText: 1,						//byte41 ~ 42: 3 安全带未系文字提示
		carDoorText: 1,						//byte41 ~ 42: 4 车门未关文字提示
		tireText: 1,						//byte41 ~ 42: 5 胎压故障文字提示
		sysText: 1,							//byte41 ~ 42: 6 系统故障文字提示
		remain5: 9;							//byte41 ~ 42: 7 ~ 15 预留5
